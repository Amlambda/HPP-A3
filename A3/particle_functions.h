...
double get_pos_1D(particle_t * __restrict target, int indexTarget, particle_t * __restrict others, char coord, double delta_t, int N);
...
double get_force_1D(particle_t * __restrict target, int indexTarget, particle_t * __restrict others, char coord, int N); 
